...
class AdministrationController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Administration']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->administrationCode));
		}
	 ...
	 * @param Administration $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='administration-form')
		{
